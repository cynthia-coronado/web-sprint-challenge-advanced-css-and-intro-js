...
function get20s(array){
  let newArray = [];
    ...
    if (Number(dates[0]) >= 1900 && Number(dates[1]) <= 2000) {
...
function removeArtist(array, indexRemove){
   array = array.slice(indexRemove);
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, '20', 'Cynthia Coroando', '1992-2021', 'Web Design', 'European', 'Take a sad song and make it better Remember to let her into your heart Then you can start to make it better.'));
